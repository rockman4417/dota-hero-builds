export const ITEMS = {
    ...
    "recipe_magic_wand": {
        "id": 35,
        "img": "/apps/dota2/images/items/recipe_lg.png?t=1593394157044",
    ...
    "holy_locket": {
        "hint": [
            "Active: Energy ChargeTarget an allied unit to instantly restores 15 health and mana per charge stored. Max 20 charges. Gains a charge whenever a visible enemy within 1200 range uses an ability.  ",
            "",
    ...
    "abyssal_blade": {
        "hint": [
            "Active: Overwhelm Blinks to and stuns a target enemy unit for 1.8 seconds. Pierces Spell Immunity.Range: 600",
            "Passive: Bash Grants melee heroes a 25% chance on hit to stun the target for 1.5 seconds and deal 100 bonus physical damage.  Bash chance for ranged heroes is 10%.",
            "Passive: Damage Block Grants a 50% chance to block 70 damage from incoming attacks on melee heroes, and 35 damage on ranged."
        ],
        "id": 208,
